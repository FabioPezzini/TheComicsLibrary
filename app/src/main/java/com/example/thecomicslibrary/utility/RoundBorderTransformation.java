...
public class RoundBorderTransformation implements com.squareup.picasso.Transformation {
    ...
    public RoundBorderTransformation(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundBorderTransformation(int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = radius * 2;
        mMargin = margin;
